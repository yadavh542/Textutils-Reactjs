    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to="/textform">{props.textHome}</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="/about">{props.textAbout}</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="/">{props.textContact}</Link>
        </li>
      </ul>
      {  /*
...
Navbar.propTypes={title:PropTypes.string.isRequired, 
                  ...
                  textContact: PropTypes.string.isRequired,
